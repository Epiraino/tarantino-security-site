...
const services = [
  ...
  },
  {
    ...
    title: "Mobile Patrol",
    description:
      "Regular patrol routes covering multiple locations with documented check-ins and incident response.",
  },
  {
    icon: KeyRound,
  ...
  },
  {
    ...
    description:
      "Professional security staffing for corporate events, private functions, and public gatherings.",
  },
  {
    icon: Building2,
      ...
      <div className="container">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <div
              key={service.title}
              className="group rounded-xl border border-border bg-card p-6 transition-all card-elevated hover:-translate-y-1"
            >
